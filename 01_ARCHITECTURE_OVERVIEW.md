...
└───────────────────────┬─────────────────────────────┘
                        │
┌───────────────────────▼─────────────────────────────┐
│           Frontend Layer — Next.js 16 (Vercel)       │
...
Current baseline:
- Frontend pinned to `Next.js 16.2.4`
- Backend pinned to `Django 5.2.13`, which is the latest compatible line with the current `SimpleJWT` stack
